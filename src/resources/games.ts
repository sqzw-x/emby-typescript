...
export class Games extends APIResource {
  ...
  findSimilar(
    id: string,
    query: GameFindSimilarParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get(path`/Games/${id}/Similar`, { query, ...options });
  }
}

export interface GameFindSimilarParams {
  /**
...
export declare namespace Games {
  export { type GameFindSimilarParams as GameFindSimilarParams };
}
