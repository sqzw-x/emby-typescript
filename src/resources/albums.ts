...
export class Albums extends APIResource {
  ...
  createInstantMix(
    id: string,
    query: AlbumCreateInstantMixParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get(path`/Albums/${id}/InstantMix`, { query, ...options });
  }
  ...
  listSimilar(
    id: string,
    query: AlbumListSimilarParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get(path`/Albums/${id}/Similar`, { query, ...options });
  }
}

export interface AlbumCreateInstantMixParams {
  /**
...
export interface AlbumListSimilarParams {
  /**
   * Optional, include image information in output
   */
  EnableImages?: boolean | null;
