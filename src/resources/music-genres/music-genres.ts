...
import { ImageRetrieveByTypeAndIndexParams, ImageRetrieveByTypeParams, Images } from './images';
import * as InstantMixAPI from './instant-mix';
import { InstantMix, InstantMixCreateForGenreParams, InstantMixCreateParams } from './instant-mix';
import { APIPromise } from '../../core/api-promise';
import { RequestOptions } from '../../internal/request-options';
import { path } from '../../internal/utils/path';

export class MusicGenres extends APIResource {
  instantMix: InstantMixAPI.InstantMix = new InstantMixAPI.InstantMix(this._client);
  ...
  retrieve(
    name: string,
    query: MusicGenreRetrieveParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.BaseItem> {
    return this._client.get(path`/MusicGenres/${name}`, { query, ...options });
  }
   ...
   */
  list(
    query: MusicGenreListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/MusicGenres', { query, ...options });
  }
}

export interface MusicGenreRetrieveParams {
  /**
...
export interface MusicGenreListParams {
  /**
...
MusicGenres.InstantMix = InstantMix;
MusicGenres.Images = Images;

export declare namespace MusicGenres {
  export {
