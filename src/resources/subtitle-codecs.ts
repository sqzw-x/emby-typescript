...
export class SubtitleCodecs extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: SubtitleCodecListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<AudioCodecsAPI.TagItem> {
    return this._client.get('/SubtitleCodecs', { query, ...options });
  }
}

export interface SubtitleCodecListParams {
  /**
...
export declare namespace SubtitleCodecs {
  export { type SubtitleCodecListParams as SubtitleCodecListParams };
}
