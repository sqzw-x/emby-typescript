...
export class OfficialRatings extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: OfficialRatingListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<OfficialRatingListResponse> {
    return this._client.get('/OfficialRatings', { query, ...options });
  }
}

export interface OfficialRatingListResponse {
  Items?: Array<OfficialRatingListResponse.Item>;

  TotalRecordCount?: number;
}

export namespace OfficialRatingListResponse {
  export interface Item {
    Name?: string;
  }
}

export interface OfficialRatingListParams {
  /**
...
export declare namespace OfficialRatings {
  export {
