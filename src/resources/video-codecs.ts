...
export class VideoCodecs extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: VideoCodecListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<AudioCodecsAPI.TagItem> {
    return this._client.get('/VideoCodecs', { query, ...options });
  }
}

export interface VideoCodecListParams {
  /**
...
export declare namespace VideoCodecs {
  export { type VideoCodecListParams as VideoCodecListParams };
}
