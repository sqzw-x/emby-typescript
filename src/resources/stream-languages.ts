...
export class StreamLanguages extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: StreamLanguageListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<AudioCodecsAPI.TagItem> {
    return this._client.get('/StreamLanguages', { query, ...options });
  }
}

export interface StreamLanguageListParams {
  /**
...
export declare namespace StreamLanguages {
  export { type StreamLanguageListParams as StreamLanguageListParams };
}
