...
import { ImageListParams, ImageRetrieveParams, Images } from './images';
import { APIPromise } from '../../core/api-promise';
import { RequestOptions } from '../../internal/request-options';
import { path } from '../../internal/utils/path';

export class Studios extends APIResource {
  ...
  retrieve(
    name: string,
    query: StudioRetrieveParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.BaseItem> {
    return this._client.get(path`/Studios/${name}`, { query, ...options });
  }
   ...
   */
  list(
    query: StudioListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/Studios', { query, ...options });
  }
}

export interface StudioRetrieveParams {
  /**
...
Studios.Images = Images;

export declare namespace Studios {
  export { type StudioRetrieveParams as StudioRetrieveParams, type StudioListParams as StudioListParams };
