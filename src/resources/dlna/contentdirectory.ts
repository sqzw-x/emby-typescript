...
export class Contentdirectory extends APIResource {
  /**
   * No authentication required
   */
  retrieve(uuID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.get(path`/Dlna/${uuID}/contentdirectory/contentdirectory`, {
      ...options,
  ...
  retrieveXml(uuID: string, options?: RequestOptions): APIPromise<void> {
    return this._client.get(path`/Dlna/${uuID}/contentdirectory/contentdirectory.xml`, {
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
    });
  }
