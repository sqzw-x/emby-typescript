...
export class AudioCodecs extends APIResource {
  /**
   * Requires authentication as user
   */
  list(query: AudioCodecListParams | null | undefined = {}, options?: RequestOptions): APIPromise<TagItem> {
    return this._client.get('/AudioCodecs', { query, ...options });
  }
}

export interface TagItem {
  Items?: Array<TagItem.Item>;
...
export interface AudioCodecListParams {
  /**
...
export declare namespace AudioCodecs {
  export { type TagItem as TagItem, type AudioCodecListParams as AudioCodecListParams };
}
