...
export class Shows extends APIResource {
  ...
  listEpisodes(
    ...
    return this._client.get(path`/Shows/${id}/Episodes`, {
      query,
      ...options,
   ...
   */
  listMissing(
    query: ShowListMissingParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<void> {
    return this._client.get('/Shows/Missing', {
      query,
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
    });
   ...
   */
  listNextUp(
    query: ShowListNextUpParams,
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/Shows/NextUp', { query, ...options });
  }
  ...
  listSeasons(
    id: string,
    query: ShowListSeasonsParams,
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get(path`/Shows/${id}/Seasons`, { query, ...options });
  }
  ...
  listSimilar(
    id: string,
    query: ShowListSimilarParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get(path`/Shows/${id}/Similar`, { query, ...options });
  }
   ...
   */
  listUpcoming(
    query: ShowListUpcomingParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<void> {
    return this._client.get('/Shows/Upcoming', {
      query,
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
    });
...
export interface ShowListMissingParams {
  /**
   * Optional. Return items that are siblings of a supplied item.
   */
  AdjacentTo?: string;
...
export interface ShowListNextUpParams {
  /**
   * User Id
   */
  UserId: string;
...
export interface ShowListSeasonsParams {
  /**
   * User Id
   */
  UserId: string;
...
export interface ShowListSimilarParams {
  /**
   * Optional, include image information in output
   */
  EnableImages?: boolean | null;
...
export interface ShowListUpcomingParams {
  /**
   * Optional. Return items that are siblings of a supplied item.
   */
  AdjacentTo?: string;
