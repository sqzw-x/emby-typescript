...
export class Persons extends APIResource {
  ...
  retrieve(
    ...
    return this._client.get(path`/Persons/${name}`, { query, ...options });
  }
  ...
  list(
    ...
    return this._client.get('/Persons', { query, ...options });
  }
}
...
Persons.Images = Images;

export declare namespace Persons {
  export { type PersonRetrieveParams as PersonRetrieveParams, type PersonListParams as PersonListParams };
