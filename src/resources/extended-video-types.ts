...
export class ExtendedVideoTypes extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: ExtendedVideoTypeListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<AudioCodecsAPI.TagItem> {
    return this._client.get('/ExtendedVideoTypes', { query, ...options });
  }
}

export interface ExtendedVideoTypeListParams {
  /**
...
export declare namespace ExtendedVideoTypes {
  export { type ExtendedVideoTypeListParams as ExtendedVideoTypeListParams };
}
