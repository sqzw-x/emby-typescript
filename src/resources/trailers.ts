...
export class Trailers extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: TrailerListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/Trailers', { query, ...options });
  }
  ...
  retrieveSimilar(
    id: string,
    query: TrailerRetrieveSimilarParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get(path`/Trailers/${id}/Similar`, { query, ...options });
  }
}
...
export interface TrailerRetrieveSimilarParams {
  /**
   * Optional, include image information in output
   */
  EnableImages?: boolean | null;
