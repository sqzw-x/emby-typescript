...
export class ItemTypes extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: ItemTypeListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<AudioCodecsAPI.TagItem> {
    return this._client.get('/ItemTypes', { query, ...options });
  }
}
...
export declare namespace ItemTypes {
  export { type ItemTypeListParams as ItemTypeListParams };
}
