...
export class AudioLayouts extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: AudioLayoutListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<AudioCodecsAPI.TagItem> {
    return this._client.get('/AudioLayouts', { query, ...options });
  }
}

export interface AudioLayoutListParams {
  /**
...
export declare namespace AudioLayouts {
  export { type AudioLayoutListParams as AudioLayoutListParams };
}
