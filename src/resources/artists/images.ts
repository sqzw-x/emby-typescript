...
export class Images extends APIResource {
  ...
  listByType(
    ...
    params: ImageListByTypeParams,
    options?: RequestOptions,
  ): APIPromise<void> {
    const { Name, ...query } = params;
    return this._client.get(path`/Artists/${Name}/Images/${type}`, {
      query,
      ...options,
  ...
  retrieveByIndex(
    index: number,
    params: ImageRetrieveByIndexParams,
    options?: RequestOptions,
  ): APIPromise<void> {
    const { Name, Type, ...query } = params;
    return this._client.get(path`/Artists/${Name}/Images/${Type}/${index}`, {
      query,
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
    });
...
export interface ImageListByTypeParams {
  /**
...
export interface ImageRetrieveByIndexParams {
  /**
   * Path param: Item name
   */
  Name: string;
