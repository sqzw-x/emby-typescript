...
import * as LiveTvAPI from './live-tv';
...
export class Channels extends APIResource {
  ...
  retrieve(
    ...
    return this._client.get(path`/LiveTv/Channels/${id}`, { query, ...options });
  }
  ...
  list(
    ...
    return this._client.get('/LiveTv/Channels', { query, ...options });
  }
}
...
export declare namespace Channels {
  export { type ChannelRetrieveParams as ChannelRetrieveParams, type ChannelListParams as ChannelListParams };
}
