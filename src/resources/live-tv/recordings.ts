...
export class Recordings extends APIResource {
  ...
  retrieve(
    id: string,
    query: RecordingRetrieveParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.BaseItem> {
    return this._client.get(path`/LiveTv/Recordings/${id}`, { query, ...options });
  }

  /**
   * Requires authentication as user
   */
  list(query: RecordingListParams | null | undefined = {}, options?: RequestOptions): APIPromise<void> {
    return this._client.get('/LiveTv/Recordings', {
      query,
      ...options,
  ...
  delete(id: string, options?: RequestOptions): APIPromise<void> {
    return this._client.post(path`/LiveTv/Recordings/${id}/Delete`, {
      ...options,
      headers: buildHeaders([{ Accept: '*/*' }, options?.headers]),
    });
  }
   ...
   */
  listFolders(
    query: RecordingListFoldersParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<RecordingListFoldersResponse> {
    return this._client.get('/LiveTv/Recordings/Folders', { query, ...options });
  }

  /**
   * Requires authentication as user
   */
  listGroups(options?: RequestOptions): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/LiveTv/Recordings/Groups', options);
  }

  /**
   * Requires authentication as user
   */
  listSeries(options?: RequestOptions): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/LiveTv/Recordings/Series', options);
  }
}
...
export type RecordingListFoldersResponse = Array<ArtistsAPI.BaseItem>;

export interface RecordingRetrieveParams {
  /**
...
export interface RecordingListFoldersParams {
  /**
   * Optional, include image information in output
   */
  EnableImages?: boolean | null;
