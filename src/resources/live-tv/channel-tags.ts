...
export class ChannelTags extends APIResource {
  /**
   * Requires authentication as user
   */
  list(
    query: ChannelTagListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/LiveTv/ChannelTags', { query, ...options });
  }
   ...
   */
  listPrefixes(
    query: ChannelTagListPrefixesParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ChannelTagListPrefixesResponse> {
    return this._client.get('/LiveTv/ChannelTags/Prefixes', { query, ...options });
  }
}

export type ChannelTagListPrefixesResponse =
  Array<ChannelTagListPrefixesResponse.ChannelTagListPrefixesResponseItem>;

export namespace ChannelTagListPrefixesResponse {
  export interface ChannelTagListPrefixesResponseItem {
    Id?: string;
...
export interface ChannelTagListParams {
  /**
...
export interface ChannelTagListPrefixesParams {
  /**
   * Optional. Return items that are siblings of a supplied item.
   */
  AdjacentTo?: string;
...
export declare namespace ChannelTags {
  export {
