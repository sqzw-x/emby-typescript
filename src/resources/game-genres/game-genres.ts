...
export class GameGenres extends APIResource {
  ...
  retrieve(
    name: string,
    query: GameGenreRetrieveParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.BaseItem> {
    return this._client.get(path`/GameGenres/${name}`, { query, ...options });
  }
   ...
   */
  list(
    query: GameGenreListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/GameGenres', { query, ...options });
  }
}

export interface GameGenreRetrieveParams {
  /**
...
export interface GameGenreListParams {
  /**
...
GameGenres.Images = Images;

export declare namespace GameGenres {
  export {
