...
export class Genres extends APIResource {
  ...
  retrieve(
    name: string,
    query: GenreRetrieveParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.BaseItem> {
    return this._client.get(path`/Genres/${name}`, { query, ...options });
  }
   ...
   */
  list(
    query: GenreListParams | null | undefined = {},
    options?: RequestOptions,
  ): APIPromise<ArtistsAPI.QueryResultBaseItem> {
    return this._client.get('/Genres', { query, ...options });
  }
}

export interface GenreRetrieveParams {
  /**
...
Genres.Images = Images;

export declare namespace Genres {
  export { type GenreRetrieveParams as GenreRetrieveParams, type GenreListParams as GenreListParams };
